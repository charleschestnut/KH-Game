...
<form:form action="building/contentManager/edit.do" modelAttribute="${buildingType}">
	...
	<br>
	<fieldset>
		<legend title="<spring:message code='building.cost'/>"></legend>
	...
	<fieldset>
		...
		<fieldset>
			...
			<legend title='<spring:message code="building.warehouse.materialsSlots"></spring:message>'></legend>
	...
	<fieldset>
		...
		<fieldset>
			...
			<legend title='<spring:message code="building.livelihood.materials"></spring:message>'></legend>
